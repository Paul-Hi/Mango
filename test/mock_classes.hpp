...
class fake_context : public mango::context_impl
{
  public:
    ...
    MOCK_METHOD(mango::weak_ptr<mango::render_system_impl>, get_render_system_internal, (), (override));
    MOCK_METHOD(mango::weak_ptr<mango::shader_system>, get_shader_system_internal, (), (override));
    MOCK_METHOD(mango::weak_ptr<mango::resource_system>, get_resource_system_internal, (), (override));
...
class fake_input : public mango::input_system_impl
{
  public:
    ...
    MOCK_METHOD(glm::vec2, get_mouse_position, (), (override));
    MOCK_METHOD(glm::vec2, get_mouse_scroll, (), (override));
