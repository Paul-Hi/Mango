...
bool editor::create()
{
    ...
    renderer_config.set_base_render_pipeline(render_pipeline::deferred_pbr).set_vsync(true);

    environment_display_settings eds;
    eds.set_render_level(0.1f);
    renderer_config.display_environment(eds);
    shadow_settings shs;
    shs.set_resolution(2048).set_sample_count(16).set_filter_mode(shadow_filtering::pcss_shadows).set_light_size(4.0f).set_offset(12.0f).set_cascade_count(4).set_split_lambda(0.6f).set_cascade_interpolation_range(0.4f);
