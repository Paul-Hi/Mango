...
namespace mango
{
    ...
    class input
    {
      public:
        ...
        virtual glm::dvec2 get_cursor_position() = 0;

        //! \brief Retrieves the current scroll offsets.
        //! \returns The scroll offset in x and y direction.
        virtual glm::dvec2 get_scroll_offset() = 0;
