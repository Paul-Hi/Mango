...
void ibl_step::bind_image_based_light_maps(command_buffer_ptr& command_buffer)
{
    ...
    if (m_cubemap)
    {
        command_buffer->bind_texture(6, m_irradiance_map, 6);       // TODO Paul: Binding and location...
        command_buffer->bind_texture(7, m_prefiltered_specular, 7); // TODO Paul: Binding and location...
        command_buffer->bind_texture(8, m_brdf_integration_lut, 8); // TODO Paul: Binding and location...
    }
    else
    {
        command_buffer->bind_texture(6, default_ibl_texture, 6);    // TODO Paul: Binding and location...
        command_buffer->bind_texture(7, default_ibl_texture, 7);    // TODO Paul: Binding and location...
        command_buffer->bind_texture(8, m_brdf_integration_lut, 8); // TODO Paul: Binding and location...
    }
