...
struct ImGui_ImplGlfw_Data
{
    ...
    bool Frame_hovered = true;
    bool Frame_focused = true;
...
void ImGui_ImplGlfw_FrameHovered(bool hovered)
{
    ...
    bd->Frame_hovered = hovered;
}

void ImGui_ImplGlfw_FrameFocused(bool focused)
{
    ImGui_ImplGlfw_Data* bd = ImGui_ImplGlfw_GetBackendData();
    bd->Frame_focused = focused;
}
...
{
    ImGui_ImplGlfw_Data* bd = ImGui_ImplGlfw_GetBackendData();
    bool handle = bd->Frame_hovered;
    if (action == GLFW_RELEASE || (bd->PrevUserCallbackMousebutton != NULL && window == bd->Window && handle))
...
void ImGui_ImplGlfw_ScrollCallback(GLFWwindow* window, double xoffset, double yoffset)
{
    ImGui_ImplGlfw_Data* bd = ImGui_ImplGlfw_GetBackendData();
    bool handle = bd->Frame_hovered;
    if (bd->PrevUserCallbackScroll != NULL && window == bd->Window && handle)
...
{
    ImGui_ImplGlfw_Data* bd = ImGui_ImplGlfw_GetBackendData();
    bool handle = bd->Frame_focused;
    if (bd->PrevUserCallbackKey != NULL && window == bd->Window && handle)
...
void ImGui_ImplGlfw_CharCallback(GLFWwindow* window, unsigned int c)
{
    ImGui_ImplGlfw_Data* bd = ImGui_ImplGlfw_GetBackendData();
    bool handle = bd->Frame_focused;
    if (bd->PrevUserCallbackChar != NULL && window == bd->Window && handle)
