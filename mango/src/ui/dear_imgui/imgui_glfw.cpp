...
static GLFWcursorposfun g_PrevUserCallbackMouseposition = NULL;
...
static bool g_frame_hovered                             = true;
static bool g_frame_focused                             = true;
...
void ImGui_ImplGlfw_FrameHovered(bool hovered)
{
    g_frame_hovered = hovered;
}

void ImGui_ImplGlfw_FrameFocused(bool focused)
{
    g_frame_focused = focused;
}

void ImGui_ImplGlfw_KeyCallback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
    ImGuiIO& io = ImGui::GetIO();
    bool handle = g_frame_focused;
    if (g_PrevUserCallbackKey != NULL && window == g_Window && handle)
...
{
    bool handle = g_frame_hovered;
    if (g_PrevUserCallbackMouseposition != NULL && window == g_Window && handle)
...
{
    bool handle = g_frame_hovered;
    if (g_PrevUserCallbackDragNDrop != NULL && window == g_Window && handle)
...
void ImGui_ImplGlfw_ScrollCallback(GLFWwindow* window, double xoffset, double yoffset)
{
    ImGuiIO& io = ImGui::GetIO();
    bool handle = g_frame_hovered;
    if (g_PrevUserCallbackScroll != NULL && window == g_Window && handle)
...
void ImGui_ImplGlfw_CharCallback(GLFWwindow* window, unsigned int c)
{
    ImGuiIO& io = ImGui::GetIO();
    bool handle = g_frame_focused;
    if (g_PrevUserCallbackChar != NULL && window == g_Window && handle)
...
static bool ImGui_ImplGlfw_Init(GLFWwindow* window, bool install_callbacks, GlfwClientApi client_api)
{
    ...
    g_PrevUserCallbackMouseposition = NULL;
    g_PrevUserCallbackScroll        = NULL;
    g_PrevUserCallbackDragNDrop     = NULL;
    ...
    if (install_callbacks)
    {
        ...
        g_PrevUserCallbackMouseposition = glfwSetCursorPosCallback(window, ImGui_ImplGlfw_MousePositionCallback);
        g_PrevUserCallbackScroll        = glfwSetScrollCallback(window, ImGui_ImplGlfw_ScrollCallback);
        g_PrevUserCallbackDragNDrop     = glfwSetDropCallback(window, ImGui_ImplGlfw_DragNDropCallback);
