...
void ui_impl::setup()
{
    ...
    // io.ConfigFlags |= ImGuiConfigFlags_ViewportsEnable; // Enable Multi-Viewport / Platform Windows // TODO Should be enabled as soon as we can provide working input for that.
