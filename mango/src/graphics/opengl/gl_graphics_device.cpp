...
graphics_pipeline_create_info gl_graphics_device::provide_graphics_pipeline_create_info()
{
    ...
    result.blend_state.blend_description.src_color_blend_factor = gfx_blend_factor::blend_factor_zero;
    result.blend_state.blend_description.dst_color_blend_factor = gfx_blend_factor::blend_factor_one;
    result.blend_state.blend_description.color_blend_operation  = gfx_blend_operation::blend_operation_add;
    result.blend_state.blend_description.src_alpha_blend_factor = gfx_blend_factor::blend_factor_zero;
    result.blend_state.blend_description.dst_alpha_blend_factor = gfx_blend_factor::blend_factor_one;
    result.blend_state.blend_description.alpha_blend_operation  = gfx_blend_operation::blend_operation_add;
