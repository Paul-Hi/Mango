...
namespace mango
{
    ...
    class gl_graphics_device_context : public graphics_device_context
    {
      public:
        ...
        void set_render_targets(int32 count, gfx_handle<const gfx_image_texture_view>* render_targets, gfx_handle<const gfx_image_texture_view> depth_stencil_target) override;
