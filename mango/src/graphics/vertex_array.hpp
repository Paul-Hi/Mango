...
namespace mango
{
    ...
    class vertex_array : public graphics_object
    {
      public:
        ...
        virtual void bind_vertex_buffer(g_uint index, buffer_ptr buffer, g_intptr offset, g_sizei stride);
        ...
        virtual void bind_index_buffer(buffer_ptr buffer, index_type type);
        ...
        virtual void set_vertex_attribute(g_uint index, g_uint buffer_index, format attribute_format, g_uint relative_offset);
