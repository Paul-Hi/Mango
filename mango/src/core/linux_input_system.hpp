//! \file      linux_input_system.hpp
//! \author    Paul Himmler
//! \version   1.0
//! \date      2020
//! \copyright Apache License 2.0

#ifndef MANGO_LINUX_INPUT_SYSTEM_HPP
#define MANGO_LINUX_INPUT_SYSTEM_HPP

#include <core/input_system_impl.hpp>

namespace mango
{
    //! \brief The \a input_system for the linux platform.
    class linux_input_system : public input_system_impl
    {
      public:
        //! \brief Constructs the \a linux_input_system.
        //! \param[in] context The internally shared context of mango.
        linux_input_system(const shared_ptr<context_impl>& context);
...
#endif // MANGO_LINUX_INPUT_SYSTEM_HPP
